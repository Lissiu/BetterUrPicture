...
// REQUIRES: photoname, absPath, camera, date are not null;
//           iso > 0, aperture > 0, shutter > 0
...
// REQUIRES: name is non-null and trimmed length > 0 and
//           no existing album has the same name ignoring case
// MODIFIES: lib
...
// REQUIRES: album and photo are not null
// MODIFIES: album
...
// REQUIRES: album is not null;
//          newName is non-null and trimmed length > 0;
//         no other album has the same name ignoring case
// MODIFIES: lib, sidecars
