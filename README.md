...
**BetterThePicture** is a Java desktop application that helps users document and reflect on their photography. Users can record photo entries along with technical details like camera model, aperture, shutter speed, ISO, and scene descriptions. They can also write down thoughts and improvements, and mark any areas in the photo they feel could be improved (e.g., lighting, composition). Over time, this creates a personalized learning gallery that can be revisited to better understand how to take great photos in similar situations.
...
- As a user, I want to be able to visually mark areas of a photo that need improvement, such as regions with bad lighting or focus issues.
